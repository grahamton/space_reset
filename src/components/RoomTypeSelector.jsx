  ...
  return (
    <div className="w-full space-y-4">
      <div className="text-center">
        <h3 className="text-lg font-bold text-gray-900 mb-2">Which room?</h3>
        <p className="text-sm text-gray-600">So your missions fit the space.</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        {roomTypes.map((room) => (
          <button
            ...
            aria-pressed={selectedRoomType === room.id}
